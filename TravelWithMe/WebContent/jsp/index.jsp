    	...
    	<div class="modal-dialog">
      		<div class="modal-content">
		        ...
		        <div class="modal-body">
		          	해당 서비스를 효율적으로 이용하기 위한 가이드입니다.<hr>
		          	1. 신뢰지수<br>
		         	&nbsp;신뢰지수는 신규회원에게 100점이 부여되고 NoShow가 발생하여 평가에서 감점점수를 받게되면 차감하는 제도입니다.<hr>
				 	2. 가이드등급<br>
				 	&nbsp;가이드등급은 가이드 투어를 작성하여 투어를 다녀온 후 참여자들의 평가점수를 바탕으로 계산된 등급입니다.<br>
		        </div>
